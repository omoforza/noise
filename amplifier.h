	...
	private:
		...
		*/
		AmpA AA{4.0e3L,2.0e-9L};
                AmpB BB{1500.0L,22.0e3L,0.5L,4.7e3L,3.0e-12L,G};
                AmpC CC{4.7e3L,4.7e3L,0.5L,4.7e3L,3.0e-12L, 40.0e-9L,G};
                AmpC DD{4.7e3L,4.7e3L,0.5L,22.0e3L,3.0e-12L,40.0e-9L,G};
                AmpC EE{22.0e3L,22.0e3L,0.5L,1.0L/(1.0L/4.7e3L+1.0L/1.0e6L),3.0e-12L,40.0e-9L,G};
